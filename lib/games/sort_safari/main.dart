...
class SortSafariRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const SortSafariRoot({
    super.key,
  ...
  @override
  State<SortSafariRoot> createState() => _SortSafariRootState();
}

class _SortSafariRootState extends State<SortSafariRoot>
  ...
  Future<void> _initializeBackgroundMusic() async {
    try {
      ...
      await _audioPlayer.setSource(
        AssetSource('games/sort_safari/music/bgm.mp3'),
      );
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Image.asset(
                        'assets/games/sort_safari/images/logo.png',
                        width: size.width * 0.7,
                        fit: BoxFit.contain,
                      ),
                      const SizedBox(height: 36),
                      _woodButton(
                        assetPath: 'assets/games/sort_safari/images/start.png',
                      ...
                      _woodButton(
                        assetPath: 'assets/games/sort_safari/images/htp.png',
                        onTap: () {
                      ...
                      const SizedBox(height: 18),
                      _woodButton(
                        assetPath: 'assets/games/sort_safari/images/quit.png',
                        onTap: () {
                          showDialog(
                            context: context,
                            builder: (ctx) => AlertDialog(
