...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  late AnimationController _howToPlayAnimController;
  late Animation<double> _howToPlayScaleAnim;
  ...
  void initState() {
    ...
    _howToPlayAnimController = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 300),
    );
    _howToPlayScaleAnim = CurvedAnimation(
      parent: _howToPlayAnimController,
      curve: Curves.easeOutBack,
    );
    _initGame();
  }
  ...
  void dispose() {
    ...
    _howToPlayAnimController.dispose();
    super.dispose();
  }
  ...
  void _refillDraggables() {
    ...
    while (draggableNumbers.length < 4 && fallbackPool.isNotEmpty) {
      draggableNumbers.add(
        fallbackPool.removeAt(random.nextInt(fallbackPool.length)),
      );
    }
            ...
            child: DragTarget<int>(
              ...
              builder: (context, candidateData, rejectedData) {
                return Container(
                  ...
                  child: val == null
                      ? Image.asset(
                          'assets/games/number_quest/images/blank.png',
                        )
                      : Image.asset(
                          'assets/games/number_quest/images/$val.png',
                        ),
                );
              },
            ),
          ...
          return Padding(
            ...
            child: Draggable<int>(
              ...
              feedback: Material(
                ...
                child: Image.asset(
                  'assets/games/number_quest/images/$n.png',
                  height: 64,
                ),
              ),
  ...
  Widget _buildMenuPopup() {
    final scaleAnim = _menuScaleAnim ?? AlwaysStoppedAnimation(1.0);
              ...
              child: Column(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Image.asset(
                      "assets/games/number_quest/images/continue.png",
                      height: 80,
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        showMenuPopup = false; // close pause menu
                      });
                      Future.delayed(const Duration(milliseconds: 300), () {
                        setState(() {
                          showHowToPlay = true;
                        });
                        _howToPlayAnimController.forward(from: 0);
                      });
                    },
                    child: Image.asset(
                      "assets/games/number_quest/images/htp.png",
                      height: 80,
                    ),
                  ),
                  const SizedBox(height: 20),
                  GestureDetector(
                    ...
                    child: Image.asset(
                      "assets/games/number_quest/images/quit.png",
                      height: 80,
                    ),
                  ),
                ],
  ...
  Widget _buildHowToPlayPopup() => AnimatedOpacity(
    ...
    child: Visibility(
      ...
      child: Container(
        ...
        child: Center(
          child: ScaleTransition(
            scale: _howToPlayScaleAnim,
            child: Stack(
              alignment: Alignment.topRight,
              children: [
                Center(
                  child: Image.asset(
                    "assets/games/number_quest/images/how.png",
                    width: 300,
                    fit: BoxFit.contain,
                  ),
                ),
                Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: Image.asset(
                      "assets/games/number_quest/images/x.png",
                      height: 45,
                    ),
                  ),
                ),
      ...
      child: Container(
        ...
        child: Center(
          child: Stack(
            ...
            children: [
              Image.asset(
                "assets/games/number_quest/images/complete.png",
                height: 450,
                width: 350,
              ),
              Column(
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => Navigator.pop(context),
                        child: Image.asset(
                          "assets/games/number_quest/images/home.png",
                          height: 60,
                        ),
                      ),
                      ...
                      GestureDetector(
                        ...
                        child: Image.asset(
                          "assets/games/number_quest/images/restart.png",
                          height: 60,
                        ),
                      ),
                    ],
            ...
            Container(
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/games/number_quest/images/bg2.png"),
                  fit: BoxFit.cover,
                ),
              ),
              child: SafeArea(
                      ...
                      child: Row(
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              Image.asset(
                                "assets/games/number_quest/images/scoreplaceholder.png",
                                height: 60,
                              ),
                              Padding(
                          ...
                          GestureDetector(
                            ...
                            child: Image.asset(
                              "assets/games/number_quest/images/menu.png",
                              height: 50,
                            ),
                          ),
                        ],
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: const DecorationImage(
                                image: AssetImage(
                                  "assets/games/number_quest/images/wood.png",
                                ),
                                fit: BoxFit.fill,
                              ),
