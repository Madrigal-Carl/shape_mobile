...
class NumberQuestRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const NumberQuestRoot({
    super.key,
  ...
  @override
  State<NumberQuestRoot> createState() => _NumberQuestRootState();
}

class _NumberQuestRootState extends State<NumberQuestRoot>
  ...
  Future<void> _initMusic() async {
    try {
      ...
      await _audioPlayer.setSource(
        AssetSource('games/number_quest/music/bgm.mp3'),
      );
      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            Positioned.fill(
              child: Image.asset(
                'assets/games/number_quest/images/bg.png',
                fit: BoxFit.cover,
              ),
            ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Image.asset(
                        'assets/games/number_quest/images/logo.png',
                      ...
                      // ▶️ Start button
                      _woodButton(
                        assetPath: 'assets/games/number_quest/images/start.png',
                        width: buttonWidth,
                        onTap: () {
                          Navigator.push(
                            context,
                      ...
                      // ❓ How to Play button
                      _woodButton(
                        assetPath: 'assets/games/number_quest/images/htp.png',
                        width: buttonWidth,
                        onTap: () {
                      ...
                      // ❌ Quit button (✅ fixed)
                      _woodButton(
                        assetPath: 'assets/games/number_quest/images/quit.png',
                        width: buttonWidth,
