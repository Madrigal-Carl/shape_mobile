...
class FruitAdditionRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const FruitAdditionRoot({
    super.key,
  ...
  @override
  State<FruitAdditionRoot> createState() => _FruitAdditionRootState();
}

class _FruitAdditionRootState extends State<FruitAdditionRoot>
  ...
  Future<void> _initMusic() async {
    try {
      ...
      await _audioPlayer.setSource(
        AssetSource('games/fruit_addition/music/bgm.mp3'),
      );
      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            Positioned.fill(
              child: Image.asset(
                'assets/games/fruit_addition/images/bg.png',
                fit: BoxFit.cover,
              ),
            ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Image.asset(
                        'assets/games/fruit_addition/images/logo.png',
                      ...
                      _woodButton(
                        assetPath:
                            'assets/games/fruit_addition/images/start.png',
                        width: buttonWidth,
                        onTap: () {
                          Navigator.push(
                            context,
                      ...
                      // ❓ How to Play button
                      _woodButton(
                        assetPath: 'assets/games/fruit_addition/images/htp.png',
                        width: buttonWidth,
                        onTap: () {
