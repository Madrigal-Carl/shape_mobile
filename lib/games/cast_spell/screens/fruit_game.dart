...
class _FruitGameScreenState extends State<FruitGameScreen>
  ...
  late List<Map<String, String>> unusedFruits;
  ...
  void initState() {
    ...
    unusedFruits = List.from(fruitWords);
    _generateNewWord();
  }
  ...
  void _generateNewWord() {
    ...
    setState(() {
      ...
      currentWordData = unusedFruits.removeAt(
        random.nextInt(unusedFruits.length),
      );
      ...
      child: Scaffold(
        body: Stack(
          ...
          children: [
            Positioned.fill(
              child: Image.asset(
                'assets/games/cast_spell/images/bg2.png',
                fit: BoxFit.cover,
              ),
            ),
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              Image.asset(
                                'assets/games/cast_spell/images/scoreplaceholder.png',
                                width: 200,
                              ),
                              Padding(
                          ...
                          GestureDetector(
                            ...
                            child: Image.asset(
                              'assets/games/cast_spell/images/menu.png',
                              width: 55,
                            ),
                          ),
                        ],
                    ...
                    ScaleTransition(
                      ...
                      child: AnimatedSwitcher(
                        duration: const Duration(milliseconds: 400),
                        child: Image.asset(
                          'assets/games/cast_spell/images/${currentWordData['image']}',
                    ...
                    AnimatedBuilder(
                      ...
                      child: Wrap(
                        ...
                        spacing: 6,
                        runSpacing: 4,
                        children: currentWord.split('').asMap().entries.map((
                          entry,
                        ) {
                          int i = entry.key;
                              ...
                              builder: (context, accepted, rejected) {
                                ...
                                return AnimatedContainer(
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      Image.asset(
                                        'assets/games/cast_spell/images/blank_wood.png',
                                        width: tileSize,
                                      ),
                                      if (droppedLetter != null)
                                        Image.asset(
                                          'assets/games/cast_spell/images/letter_${droppedLetter!.toLowerCase()}.png',
                                          width: tileSize - 10,
                                        ),
                                    ],
                                  ),
              ...
              _dim(
                ScaleTransition(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Image.asset(
                        "assets/games/cast_spell/images/overlay.png",
                        width: 330,
                      ),
                      Positioned(
                        top: 96,
  ...
  Widget popupIcon(String file, VoidCallback onTap) => GestureDetector(
    onTap: onTap,
    child: Image.asset("assets/games/cast_spell/images/$file", width: 55),
  );

  Widget menuBtn(String file, VoidCallback onTap) => GestureDetector(
    onTap: onTap,
    child: Image.asset("assets/games/cast_spell/images/$file", width: 220),
  );
}
