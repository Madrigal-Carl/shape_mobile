...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  void _spawnBalloon() {
    ...
    final images = [
      'assets/games/balloon_pop/images/balloon.png',
      'assets/games/balloon_pop/images/balloon1.png',
      'assets/games/balloon_pop/images/balloon2.png',
      'assets/games/balloon_pop/images/balloon3.png',
    ];
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (!showMenu && !showHow && !gameCompleted) {
          _pauseGame();
          return false;
        } else if (showHow) {
          setState(() {
      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            Positioned.fill(
              child: Image.asset(
                'assets/games/balloon_pop/images/bg2.png',
                fit: BoxFit.cover,
              ),
            ),
            ...
            if (!gameCompleted)
              Positioned(
                ...
                child: GestureDetector(
                  onTap: _pauseGame,
                  child: Image.asset(
                    'assets/games/balloon_pop/images/menu.png',
                    width: 50,
                    height: 70,
                  ),
                ),
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Row(
                      ...
                      children: [
                        _popupButton(
                          'assets/games/balloon_pop/images/continue.png',
                          _resumeGame,
                        ),
                        const SizedBox(width: 40),
                        _popupButton(
                          'assets/games/balloon_pop/images/htp.png',
                          () {
                            setState(() {
                              showHow = true;
                              showMenu = false;
                        ...
                        const SizedBox(width: 40),
                        _popupButton(
                          'assets/games/balloon_pop/images/quit.png',
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Stack(
                      ...
                      children: [
                        Image.asset(
                          'assets/games/balloon_pop/images/complete.png', // 🪵 Wooden board
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Image.asset(
                                  'assets/games/balloon_pop/images/home.png',
                                  width: 70,
                                  height: 90,
                                ),
                              ),
                              ...
                              GestureDetector(
                                onTap: _restartGame,
                                child: Image.asset(
                                  'assets/games/balloon_pop/images/restart.png',
                                  width: 70,
                                  height: 90,
                                ),
                              ),
      ...
      builder: (context, child) {
        ...
        return Positioned(
          ...
          child: Opacity(
            opacity: opacity,
            child: Image.asset(
              'assets/games/balloon_pop/images/${widget.letter.toLowerCase()}.png',
              width: 100,
              height: 100,
              fit: BoxFit.contain,
            ),
