...
class FairlyMultiplicationRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const FairlyMultiplicationRoot({
    super.key,
  ...
  @override
  State<FairlyMultiplicationRoot> createState() =>
      _FairlyMultiplicationRootState();
}

class _FairlyMultiplicationRootState extends State<FairlyMultiplicationRoot>
