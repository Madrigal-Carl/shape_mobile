...
class TracingTimeRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const TracingTimeRoot({
    super.key,
  ...
  @override
  State<TracingTimeRoot> createState() => _TracingTimeRootState();
}

class _TracingTimeRootState extends State<TracingTimeRoot>
  ...
  Future<void> _initializeBackgroundMusic() async {
    try {
      ...
      await _audioPlayer.setSource(
        AssetSource('games/tracing_time/music/bgm.mp3'),
      );
      ...
      child: Scaffold(
        body: Stack(
          children: [
            Positioned.fill(
              child: Image.asset(
                'assets/games/tracing_time/images/bg.png',
                fit: BoxFit.cover,
              ),
            ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Image.asset(
                        'assets/games/tracing_time/images/logo.png',
                        width: size.width * 0.7,
                        fit: BoxFit.contain,
                      ),
                      const SizedBox(height: 36),
                      _woodButton(
                        assetPath: 'assets/games/tracing_time/images/start.png',
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                      ...
                      _woodButton(
                        assetPath: 'assets/games/tracing_time/images/htp.png',
                        onTap: () {
                      ...
                      const SizedBox(height: 18),
                      _woodButton(
                        assetPath: 'assets/games/tracing_time/images/quit.png',
                        onTap: _confirmExit,
                      ),
                      const SizedBox(height: 40),
                    ],
