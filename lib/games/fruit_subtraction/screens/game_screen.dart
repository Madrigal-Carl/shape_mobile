  ...
  Widget draggableNum(String img, int value) {
    return Draggable<int>(
      ...
      feedback: Image.asset(
        "assets/games/fruit_subtraction/images/$img",
        height: 60,
      ),
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage(
                "assets/games/fruit_subtraction/images/woodbox.png",
              ),
              fit: BoxFit.cover,
            ),
          ),
          ...
          child: currentValue != null
              ? Image.asset(
                  "assets/games/fruit_subtraction/images/$currentValue.png",
                  height: 45,
                )
              : const SizedBox(),
        ),
        ...
        Row(
          ...
          children: List.generate(
            ...
            (j) => Padding(
              ...
              child: Image.asset(
                "assets/games/fruit_subtraction/images/$currentFruit.png",
                height: 60,
              ),
            ),
          ),
          ...
          children: [
            Container(
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                    "assets/games/fruit_subtraction/images/bg2.png",
                  ),
                  fit: BoxFit.cover,
                ),
              ),
              child: SafeArea(
                child: Column(
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              Image.asset(
                                "assets/games/fruit_subtraction/images/scoreplaceholder.png",
                                height: 60,
                              ),
                              Padding(
                          ...
                          GestureDetector(
                            ...
                            child: Image.asset(
                              "assets/games/fruit_subtraction/images/menu.png",
                              height: 50,
                            ),
                          ),
                        ],
                    ...
                    const SizedBox(height: 30),
                    Image.asset(
                      "assets/games/fruit_subtraction/images/add.png",
                      height: 15,
                    ),
                    const SizedBox(height: 30),
                    ...
                    const SizedBox(height: 30),
                    Image.asset(
                      "assets/games/fruit_subtraction/images/equals.png",
                      height: 25,
                    ),
                    const SizedBox(height: 30),
          ...
          child: Column(
            ...
            children: [
              GestureDetector(
                ...
                child: Image.asset(
                  "assets/games/fruit_subtraction/images/continue.png",
                  height: 70,
                ),
              ),
  ...
  Widget _buildEndOverlay() => Container(
    ...
    child: Center(
      child: Stack(
        ...
        children: [
          Image.asset(
            "assets/games/fruit_subtraction/images/overlay.png",
            height: 250,
            width: 350,
          ),
          Column(
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () => Navigator.pop(context),
                    child: Image.asset(
                      "assets/games/fruit_subtraction/images/home.png",
                      height: 60,
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: Image.asset(
                      "assets/games/fruit_subtraction/images/restart.png",
                      height: 60,
                    ),
                  ),
                ],
