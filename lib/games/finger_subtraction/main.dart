...
class FingerSubtractionRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const FingerSubtractionRoot({
    super.key,
  ...
  @override
  State<FingerSubtractionRoot> createState() => _FingerSubtractionRootState();
}

class _FingerSubtractionRootState extends State<FingerSubtractionRoot>
  ...
  Future<void> _initMusic() async {
    try {
      ...
      await _audioPlayer.setSource(
        AssetSource('games/finger_subtraction/music/bgm.mp3'),
      );
      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            Positioned.fill(
              child: Image.asset(
                'assets/games/finger_subtraction/images/bg.png',
                fit: BoxFit.cover,
              ),
            ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Image.asset(
                        'assets/games/finger_subtraction/images/logo.png',
                      ...
                      _woodButton(
                        assetPath:
                            'assets/games/finger_subtraction/images/start.png',
                        width: buttonWidth,
                        onTap: () {
                          Navigator.push(
                            context,
