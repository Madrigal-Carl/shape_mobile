...
class EmotionTestRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const EmotionTestRoot({
    super.key,
  ...
  @override
  State<EmotionTestRoot> createState() => _EmotionTestRootState();
}

class _EmotionTestRootState extends State<EmotionTestRoot>
  ...
  Future<void> _initMusic() async {
    try {
      ...
      await _audioPlayer.setSource(
        AssetSource('games/emotion_test/music/bgm.mp3'),
      );
      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            Positioned.fill(
              child: Image.asset(
                'assets/games/emotion_test/images/bg.png',
                fit: BoxFit.cover,
              ),
            ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Image.asset(
                        'assets/games/emotion_test/images/logo.png',
                      ...
                      // ▶️ Start button
                      _woodButton(
                        assetPath: 'assets/games/emotion_test/images/start.png',
                        width: buttonWidth,
                        onTap: () {
                          Navigator.push(
                            context,
                      ...
                      // ❓ How to Play button
                      _woodButton(
                        assetPath: 'assets/games/emotion_test/images/htp.png',
                        width: buttonWidth,
                        onTap: () {
                      ...
                      // ❌ Quit button (✅ fixed)
                      _woodButton(
                        assetPath: 'assets/games/emotion_test/images/quit.png',
                        width: buttonWidth,
