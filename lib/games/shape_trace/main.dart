...
class ShapeTraceRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const ShapeTraceRoot({
    super.key,
  ...
  @override
  State<ShapeTraceRoot> createState() => _ShapeTraceRootState();
}

class _ShapeTraceRootState extends State<ShapeTraceRoot>
  ...
  Future<void> _initializeBackgroundMusic() async {
    try {
      ...
      await _audioPlayer.setSource(
        AssetSource('games/shape_trace/music/bgm.mp3'),
      );
      ...
      child: Scaffold(
        body: Stack(
          children: [
            Positioned.fill(
              child: Image.asset(
                'assets/games/shape_trace/images/bg.png',
                fit: BoxFit.cover,
              ),
            ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Image.asset(
                        'assets/games/shape_trace/images/logo.png',
                        width: size.width * 0.7,
                        fit: BoxFit.contain,
                      ),
                      const SizedBox(height: 36),
                      _woodButton(
                        assetPath: 'assets/games/shape_trace/images/start.png',
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                      ...
                      _woodButton(
                        assetPath: 'assets/games/shape_trace/images/htp.png',
                        onTap: () {
                      ...
                      const SizedBox(height: 18),
                      _woodButton(
                        assetPath: 'assets/games/shape_trace/images/quit.png',
