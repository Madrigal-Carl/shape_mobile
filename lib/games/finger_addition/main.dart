...
class FingerAdditionRoot extends StatefulWidget {
  final int lessonId;
  final int studentId;
  final int gameId;

  const FingerAdditionRoot({
    super.key,
  ...
  @override
  State<FingerAdditionRoot> createState() => _FingerAdditionRootState();
}

class _FingerAdditionRootState extends State<FingerAdditionRoot>
  ...
  Future<void> _initMusic() async {
    try {
      ...
      await _audioPlayer.play(
        AssetSource('games/finger_addition/music/bgm.mp3'),
      );
      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            Positioned.fill(
              child: Image.asset(
                'assets/games/finger_addition/images/bg.png',
                fit: BoxFit.cover,
              ),
            ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      /// Logo
                      Image.asset(
                        'assets/games/finger_addition/images/logo.png',
                      ...
                      _woodButton(
                        assetPath:
                            'assets/games/finger_addition/images/start.png',
                        width: buttonWidth,
                        onTap: () {
                          Navigator.push(
                            context,
