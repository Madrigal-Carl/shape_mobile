...
class TempGameCard extends StatelessWidget {
  final int gameId;
  final String title;

  const TempGameCard({super.key, required this.gameId, required this.title});
      ...
      children: [
        ...
        Padding(
          ...
          child: GridView.count(
            ...
            children: games
                .map((game) => TempGameCard(gameId: game.id, title: game.title))
                .toList(),
          ),
        ),
      ],
